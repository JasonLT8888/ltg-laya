...
export default class LTG_UI_view_item_sign_07 extends fgui.GComponent {
	...
	public static createInstance():LTG_UI_view_item_sign_07 {
		return <LTG_UI_view_item_sign_07><any>(fgui.UIPackage.createObject("LTCom","view_item_sign_07"));
	}
	...
	protected onConstruct(): void {
		...
		this.m_loader_title = <fgui.GLoader><any>(this.getChildAt(5));
		this.m_img_got = <fgui.GImage><any>(this.getChildAt(8));
	}
}