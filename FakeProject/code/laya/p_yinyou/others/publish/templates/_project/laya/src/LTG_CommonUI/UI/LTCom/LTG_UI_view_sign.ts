...
export default class LTG_UI_view_sign extends fgui.GComponent {
	...
	protected onConstruct(): void {
		...
		this.m_day_3 = <LTG_UI_view_item_sign_02><any>(this.getChildAt(3));
		this.m_day_2 = <LTG_UI_view_item_sign_03><any>(this.getChildAt(4));
		...
		this.m_btn_normal = <LTG_UI_btn_watchad01><any>(this.getChildAt(10));
		this.m_btn_watchad = <LTG_UI_btn_watchad01><any>(this.getChildAt(11));
	}
}