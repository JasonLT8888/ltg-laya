...
export default class LTG_UI_view_item_sign_03 extends fgui.GComponent {
	...
	public static URL:string = "ui://hbq27te38gel55";

	public static createInstance():LTG_UI_view_item_sign_03 {
		return <LTG_UI_view_item_sign_03><any>(fgui.UIPackage.createObject("LTCom","view_item_sign_03"));
	}
