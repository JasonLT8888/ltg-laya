...
export default class LTG_UI_view_item_sign_01 extends fgui.GComponent {
	...
	public static URL:string = "ui://hbq27te38gel4z";

	public static createInstance():LTG_UI_view_item_sign_01 {
		return <LTG_UI_view_item_sign_01>(fgui.UIPackage.createObject("LTCom", "view_item_sign_01"));
	}

	protected onConstruct():void {
		this.m_state_get = this.getControllerAt(0);
		this.m_img_bg = <fgui.GImage>(this.getChildAt(0));
		this.m_img_can_get = <fgui.GImage>(this.getChildAt(1));
		this.m_img_got = <fgui.GImage>(this.getChildAt(2));
		this.m_loader_icon = <fgui.GLoader>(this.getChildAt(3));
		this.m_text_day = <fgui.GTextField>(this.getChildAt(4));
		this.m_text_name = <fgui.GTextField>(this.getChildAt(5));
	}
}