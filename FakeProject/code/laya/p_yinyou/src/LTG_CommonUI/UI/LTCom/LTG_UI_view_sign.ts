...
export default class LTG_UI_view_sign extends fgui.GComponent {
	...
	public m_day_3:LTG_UI_view_item_sign_02;
	public m_day_2:LTG_UI_view_item_sign_03;
	...
	public m_btn_normal:LTG_UI_btn_watchad01;
	public m_btn_watchad:LTG_UI_btn_watchad01;
	public static URL:string = "ui://hbq27te38gel4w";

	public static createInstance():LTG_UI_view_sign {
		return <LTG_UI_view_sign>(fgui.UIPackage.createObject("LTCom", "view_sign"));
	}

	protected onConstruct():void {
		this.m_state = this.getControllerAt(0);
		this.m_day_1 = <LTG_UI_view_item_sign_01>(this.getChildAt(2));
		this.m_day_3 = <LTG_UI_view_item_sign_02>(this.getChildAt(3));
		this.m_day_2 = <LTG_UI_view_item_sign_03>(this.getChildAt(4));
		this.m_day_4 = <LTG_UI_view_item_sign_02>(this.getChildAt(5));
		this.m_day_5 = <LTG_UI_view_item_sign_05>(this.getChildAt(6));
		this.m_day_6 = <LTG_UI_view_item_sign_06>(this.getChildAt(7));
		this.m_day_7 = <LTG_UI_view_item_sign_07>(this.getChildAt(8));
		this.m_text_signed = <fgui.GTextField>(this.getChildAt(9));
		this.m_btn_normal = <LTG_UI_btn_watchad01>(this.getChildAt(10));
		this.m_btn_watchad = <LTG_UI_btn_watchad01>(this.getChildAt(11));
	}
}