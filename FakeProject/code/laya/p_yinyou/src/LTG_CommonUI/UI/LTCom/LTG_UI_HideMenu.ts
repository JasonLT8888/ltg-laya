...
export default class LTG_UI_HideMenu extends fgui.GComponent {
	...
	public static createInstance():LTG_UI_HideMenu {
		return <LTG_UI_HideMenu><any>(fgui.UIPackage.createObject("LTCom","HideMenu"));
	}
	...
	protected onConstruct(): void {
		this.m_btn_show = <fgui.GButton><any>(this.getChildAt(0));
		this.m_view_menu = <LTG_UI_view_hidemenu><any>(this.getChildAt(1));
