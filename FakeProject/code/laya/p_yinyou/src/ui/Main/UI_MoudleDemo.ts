...
export default class UI_MoudleDemo extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.m___sidegames = <fgui.GGraph>(this.getChildAt(3));
		this.m___endSG = <fgui.GGraph>(this.getChildAt(4));
		this.m___bottomgames = <fgui.GGraph>(this.getChildAt(5));
		this.m_btn_back = <fgui.GButton>(this.getChildAt(6));
		this.m___wxSG = <fgui.GGraph>(this.getChildAt(7));
	}
}