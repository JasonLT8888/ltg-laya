...
export default class UI_GameCenter extends fgui.GComponent {
	...
	public static createInstance():UI_GameCenter {
		return <UI_GameCenter>(fgui.UIPackage.createObject("LTGame", "GameCenter"));
	}

	protected onConstruct():void {
		this.m_topList = <fgui.GList>(this.getChildAt(5));
		this.m_centerList = <fgui.GList>(this.getChildAt(6));
		this.m_btn_close = <UI_btn_normal>(this.getChildAt(7));
