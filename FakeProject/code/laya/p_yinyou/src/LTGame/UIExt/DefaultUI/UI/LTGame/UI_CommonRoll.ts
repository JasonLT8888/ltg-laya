...
export default class UI_CommonRoll extends fgui.GComponent {
	...
	protected onConstruct(): void {
		...
		this.m_btn_roll = <UI_btn_double_get><any>(this.getChildAt(2));
		this.m_view_roll = <UI_view_roll_bg><any>(this.getChildAt(3));
		this.m_pointer = <fgui.GImage><any>(this.getChildAt(4));
	}
}