...
export class LTBlinnPhong_HeightFog extends Laya.Material {
    ...
    set _AlbedoIntensity(value: number) {
        if (this._albedoIntensity !== value) {
            var finalAlbedo: Laya.Vector4 = (<Laya.Vector4>this._shaderValues.getVector(LTBlinnPhong_HeightFog.ALBEDO_COLOR));
    ...
    set _MainTex_STX(x: number) {
        var tilOff: Laya.Vector4 = (<Laya.Vector4>this._shaderValues.getVector(LTBlinnPhong_HeightFog.TILING_OFFSET));
        tilOff.x = x;
    ...
    get tilingOffset(): Laya.Vector4 {
        return (<Laya.Vector4>this._shaderValues.getVector(LTBlinnPhong_HeightFog.TILING_OFFSET));
    }
    ...
    get specularColor(): Laya.Vector4 {
        return (<Laya.Vector4>this._shaderValues.getVector(LTBlinnPhong_HeightFog.MATERIAL_SPECULAR));
    }
    ...
    public static InitShader() {
        ...
        let customShader: Laya.Shader3D = Laya.Shader3D.add(LTBlinnPhong_HeightFog._shaderName, null, null, true);
    ...
    private static _shaderName = "LTBlinnPhong_HeightFog";

    static CreateFromBlinnPhong(mat: Laya.BlinnPhongMaterial): LTBlinnPhong_HeightFog {
	 ...
	 */
    clone(): any {
        var dest: LTBlinnPhong_HeightFog = new LTBlinnPhong_HeightFog();
        this.cloneTo(dest);
        return dest;
    }
    ...
    cloneTo(destObject: any): void {
        ...
        var destMaterial: LTBlinnPhong_HeightFog = (<LTBlinnPhong_HeightFog>destObject);
