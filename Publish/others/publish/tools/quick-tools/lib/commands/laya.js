        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (pubDir) {
              ...
              pubDir = _path2.default.join(dir, LAYA_CONFIG.DEFAULT_PARENT_DIR, LAYA_CONFIG.DEFAULT_WECHAT_GAME_DIR);
            }
            ...
            //生成对应目录
            dirConf = (0, _utils.mkBuildDirs)(pubDir, dir, CONFIG, LAYA_CONFIG, 'laya', isDev);
            //拷贝文件

            (0, _utils.copyFiles)(pubDir, dirConf.quickgameDir, [], LAYA_CONFIG.EXCLUDE_FILES.map(function (eFile) {
...
var _laya = require('../config/laya');

var LAYA_CONFIG = _interopRequireWildcard(_laya);
