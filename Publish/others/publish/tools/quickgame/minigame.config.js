	...
	const externals = [
		{
			...
			module_from: '../../../../bin/js/bundle.js'
			 
		},
		{
			module_name: './libs/fairygui/fairygui.js',
			module_path: './libs/fairygui/fairygui.js',
			module_from: '../../../../bin/libs/fairygui/fairygui.js'
		},
		{
			module_name: './libs/laya.core.js',
			module_path: './libs/laya.core.js',
			module_from: '../../../../bin/libs/laya.core.js'
		},
		{
			module_name: './libs/laya.d3.js',
			module_path: './libs/laya.d3.js',
			module_from: '../../../../bin/libs/laya.d3.js'
		},
		{
			module_name: './libs/laya.html.js',
			module_path: './libs/laya.html.js',
			module_from: '../../../../bin/libs/laya.html.js'
		},
		{
			module_name: './libs/laya.physics3D.js',
			module_path: './libs/laya.physics3D.js',
			module_from: '../../../../bin/libs/laya.physics3D.js'
		...
		},
		{
			...
			module_from: '../../../../bin/libs/ltgame/generator.js'
		},
		{
			module_name: './libs/ltgame/promise.js',
			module_path: './libs/ltgame/promise.js',
			module_from: '../../../../bin/libs/ltgame/promise.js'
		},
		{
			module_name: './res',
			module_path: './res',
