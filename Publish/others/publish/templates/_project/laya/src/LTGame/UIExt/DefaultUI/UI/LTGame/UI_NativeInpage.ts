...
export default class UI_NativeInPage extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.m_ad = <UI_AdInpageComp>(this.getChildAt(0));
		this.m_btn_close = <UI_btn_normal>(this.getChildAt(1));
		this.m_btn_clickad = <UI_btn_normal>(this.getChildAt(2));
		this.m_btn_clickadbg = <UI_btn_normal>(this.getChildAt(3));
