...
export default class UI_CommonEndReward extends fgui.GComponent {
	...
	protected onConstruct(): void {
		this.m_btn_toggle_check = <UI_btn_toggle_02><any>(this.getChildAt(2));
		...
		this.m___nativeinpage = <fgui.GGraph><any>(this.getChildAt(8));
		this.m___endSG = <fgui.GGraph><any>(this.getChildAt(9));
