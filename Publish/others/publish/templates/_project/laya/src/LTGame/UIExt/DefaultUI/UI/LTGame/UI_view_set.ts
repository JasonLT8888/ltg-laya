...
export default class UI_view_set extends fgui.GComponent {
	...
	public static createInstance():UI_view_set {
		return <UI_view_set><any>(fgui.UIPackage.createObject("LTGame","view_set"));
	}
	...
	protected onConstruct(): void {
		...
		this.m_toggle_music = <UI_btn_toggle_01><any>(this.getChildAt(5));
		this.m_toggle_shake = <UI_btn_toggle_01><any>(this.getChildAt(6));
	}
}