...
export default class LTG_UI_view_roll extends fgui.GComponent {
	...
	public m_btn_freeget:LTG_UI_btn_refuse;
	...
	protected onConstruct(): void {
		this.m_view_roll = <LTG_UI_view_roll_panel><any>(this.getChildAt(1));
		this.m_progress_supper = <fgui.GProgressBar><any>(this.getChildAt(3));
		this.m_btn_watchad = <LTG_UI_common_ad_btn><any>(this.getChildAt(5));
		this.m_btn_freeget = <LTG_UI_btn_refuse><any>(this.getChildAt(6));
